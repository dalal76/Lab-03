...
```
Answer: the africa is the most density continent the south amerca is the most continent in plastic waste per cap.
...
Answer:Asia is among the countries with a large population, but the waste of one person is almost incomparable with other countries
